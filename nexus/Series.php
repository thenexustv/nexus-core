...
class Series {
	...
	public static function factory($object = NULL) {
		...
		// _deprecated_function(__METHOD__, '1.1.0', 'Series::get_by_episode');
	...
	private function __construct($object) {
		...
		if ( isset($object->term_id) ) {
			...
			$this->settings = Settings::get_instance()->get_series_settings($object->term_id);
		}
	}
